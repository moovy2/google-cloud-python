...
def test__get_default_mtls_endpoint():
    ...
    assert (
        ErrorGroupServiceClient._get_default_mtls_endpoint(api_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ErrorGroupServiceClient._get_default_mtls_endpoint(api_mtls_endpoint)
        == api_mtls_endpoint
    )
    assert (
        ErrorGroupServiceClient._get_default_mtls_endpoint(sandbox_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ErrorGroupServiceClient._get_default_mtls_endpoint(sandbox_mtls_endpoint)
        == sandbox_mtls_endpoint
    )
    assert (
        ErrorGroupServiceClient._get_default_mtls_endpoint(non_googleapi)
        == non_googleapi
    )
...
def test_error_group_service_client_client_options_from_dict():
    with mock.patch(
        "google.cloud.errorreporting_v1beta1.services.error_group_service.transports.ErrorGroupServiceGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_error_group_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.errorreporting_v1beta1.services.error_group_service.transports.ErrorGroupServiceTransport.__init__"
    ) as Transport:
